...
const outputXlsx = resolve(CAREER_OPS, "output", "production-filter-refinement-v7-v8-diff-test.xlsx");
...
const result = await buildVersionDiff({
  ...
  allowOverwrite: true,
  versions: {
    v7: resolve(CAREER_OPS, "output", "production-filter-refinement-review-2026-05-01-v7.xlsx"),
